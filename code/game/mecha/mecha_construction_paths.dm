...
/datum/component/construction/unordered/mecha_chassis/chonker
	result = /datum/component/construction/mecha/chonker
	steps = list(
...
/datum/component/construction/mecha/chonker
	result = /obj/mecha/combat/chonker
	base_icon = "chonker"
	steps = list(
		//1
		list(
		...
		//5
		list(
			"key" = /obj/item/circuitboard/mecha/chonker/main,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "The wiring is adjusted."
		),
		...
		//7
		list(
			"key" = /obj/item/circuitboard/mecha/chonker/peripherals,
			"action" = ITEM_DELETE,
			"back_key" = TOOL_SCREWDRIVER,
			"desc" = "Central control module is secured."
		),
		...
		//15
		list(
			"key" = /obj/item/stack/sheet/mineral/calorite,
			"amount" = 5,
			"back_key" = TOOL_WELDER,
			"desc" = "Internal armor is welded."
		),
...
/datum/component/construction/mecha/C.H.O.N.K/custom_action(obj/item/I, mob/living/user, diff)
	if(!..())
		return FALSE
